...
const Header2 = () => {
  ...
  return (
    <header className={`site-header main-bar-wraper style-2 top-0 left-0 w-full z-[999] ${scroll ? "is-fixed" : "" }`}>
        ...
        <div className="main-bar clearfix ">
          <div className="container flex justify-between">           
            ...
            <div className="extra-nav items-center h-[64px] lg:flex relative hidden pl-[70px] order-2">
              <div className="extra-cell flex items-center">
                <ul className="flex items-center gap-[10px]">
                  <li className="inline-block">
                    <Link to={"#"}
                      className={`btn-${headerClass ? "white" : "primary" } bg-primary text-white user-btn white-btn flex items-center justify-center w-[45px] h-[45px] rounded-md shadow-[0_10px_10px_0_rgba(0,0,0,0.1)]`}
                  ...
                  <li className="inline-block">
                    <button type="button"
                      className={`btn-${headerClass ? "white" : "primary"} cart-btn bg-primary text-white white-btn flex items-center justify-center w-[45px] h-[45px] rounded-md shadow-[0_10px_10px_0_rgba(0,0,0,0.1)]`}
                      onClick={cartButton}
                    >
                    ...
                    <div style={{ transition: "all 0.5s", opacity: cart ? "1" : "0",}}>
                      <ul
            ...
            <div
              className={`header-nav lg:justify-end lg:flex-row flex-col lg:gap-0 gap-5 flex lg:grow ${ headerSidebar ? "open" : ""}`}
