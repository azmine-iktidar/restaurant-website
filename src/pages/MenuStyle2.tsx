          ...
          >
            <ul id="masonry" className="row dlab-gallery-listing gallery">
              {data.map(({ img, name }, ind) => (
                <li
                  className="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All pizza spicy"
                ...
                >
                  <div
                    className="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]"
                    data-src={img}
                  >
                    ...
                    <div className="dz-content pt-[15px] relative">
                      ...
                      <p className="category text-[13px] leading-5 uppercase">
                        Fast Food
                      </p>
                    </div>
                  </div>
