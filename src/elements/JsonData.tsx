...
export const MenuSliderArr = [
  ...
  { img: IMAGES.gellry_grid2_pic2, name: "Burger", price: "$20.00" },
];
...
export const TeamCaroselArr = [
  ...
  { img: IMAGES.image_team_pic3, name: "John Doe", position: "Senior Chef" },
];
...
export const AboutServiceArr = [
  ...
  { icon: "flaticon-chef-hat", title: "Skilled Chefs" },
  { icon: "flaticon-cocktail", title: "Best Bar" },
  { icon: "flaticon-cuisine", title: "Vegan Cuisine" },
];

export const FaqArr = [
  { title: "Q1: What are your hours of operation?", evantK: 0 , isOpen: false},
  { title: "Q2: What is your menu like?", evantK: 1, isOpen: false },
  { title: "Q3: Do you have vegetarian/vegan/gluten-free options?", evantK: 2, isOpen: false },
  { title: "Q4: Do you offer takeout or delivery?", evantK: 3, isOpen: false },
  { title: "Q5: Can I make a reservation? How do I do that?", evantK: 4, isOpen: false },
  { title: "Q6: Is your restaurant kid-friendly?", evantK: 5, isOpen: false },
  { title: "Q7: What is your menu like?", evantK: 6, isOpen: false },
];
...
export const Shop1RightContentArr = [
  { img: IMAGES.shop_pic1, name:'Double Patty Burger' },
  { img: IMAGES.shop_pic2, name:'Chicken Patty Burger' },
  { img: IMAGES.shop_pic3, name:'Veg Cripsy Burger' },
  { img: IMAGES.shop_pic4, name:'Aloo Tikki Burger' },
  { img: IMAGES.shop_pic1, name:'Pure Veg Burger' },
  { img: IMAGES.shop_pic2, name:'Chicken Burger' },
];
...
export const BackGroundColorArr = [
  ...
  { colorValue: "color_2", setStyle: "bg-color-2" },
  { colorValue: "color_3", setStyle: "bg-color-3" },
