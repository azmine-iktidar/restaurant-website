...
const SignIn = () => {
  const { showSignInForm, setShowSignInForm , 
  headerSidebar, showSidebar,
  setShowSidebar} = useContext(Context);
  const [registered, setRegistered] = useState(false);
  const [hide, setHide] = useState(false);

  return (
    <>
      <div tabIndex={1} id="drawer1"
        className={`fixed top-0 z-[1000] h-screen overflow-y-auto translate-x-full bg-white dark:bg-gray-800 ${showSignInForm ? "drawer-show" : ""}`}
      >
        <div className="p-0 overflow-y-auto">
          <button type="button" className="btn-close hover:text-[#000]"
            onClick={() => { setShowSignInForm(false);}}
          >&times;</button>
          <div className="py-[60px] px-[70px]">
            <div className="login-head text-center">
              <h4 className="text-[30px] mb-[5px]">Welcome Back</h4>
              <p className="mb-[35px] text-base">We’d love have you join our 100% remote network of creatord & freelance.</p>
              <button name="submit" value="submit" type="reset" className="btn google-btn w-100 d-block">
              ...
              <form>
                <div className="mb-[15px]">
                  ...
                  <input name="dzEmail" required type="text" className="input-group mt-2.5 flex relative border border-[#dddddd] w-full rounded-md py-2.5 px-5 focus:ring-primary"placeholder="Enter Your Email"/>
                ...
                <div className="mb-[30px]">
                  ...
                  <div className="input-group relative">
                    <input
                      ...
                      className="dzPassword mt-2.5 flex relative border border-[#dddddd] w-full rounded-md py-2.5 px-5 focus:ring-primary dz-password"
            ...
            <p className="text-center mt-[30px] text-base">
              Not registered?{" "}
              <Link
                className="register text-primary font-medium" to={"#"}
                onClick={() => {
                  setRegistered(true);
      ...
      <div
        className={`menu-backdrop ${
          showSignInForm || registered || headerSidebar || showSidebar? "show" : ""
        }`}
        onClick={() => {
          setShowSignInForm(false);
          setRegistered(false);
      ...
      ></div>
      <div
        className={`fixed top-0 z-[1000] h-screen overflow-y-auto translate-x-full bg-white dark:bg-gray-800 ${registered ? "drawer-show" : ""}`}
        tabIndex={1}
        id="drawer2"
      >
        <div className="p-0 overflow-y-auto">
          <button
            type="button"
            className="btn-close2 hover:text-[#000]"
            onClick={() => {
              setShowSignInForm(false);
              setRegistered(false);
            }}
          ...
          <div className="py-[60px] px-[70px]">
            <div className="login-head text-center">
              ...
              <p className="mb-[35px]">We’d love have you join our 100% remote network of creatord &amp; freelance.</p>
              <button name="submit" value="submit" type="reset" className="btn google-btn w-100">
                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form>
              <div className="mb-[15px]"> 
                ...
                <div className="input-group">
                  <input name="dzName" required type="text" className="input-group mt-2.5 flex relative border border-[#dddddd] w-full rounded-md py-2.5 px-5 focus:ring-primary" placeholder="Enter Your Name" />
                </div>
              </div>
              <div className="mb-[15px]">
                <label className="form-label">Email <strong className="text-danger">*</strong></label>
              ...
              <div className="mb-[30px]">
                <label htmlFor="dzPassword1" className="form-lable">Password <strong className="text-danger">*</strong></label>
                <div className="input-group relative">
                  <input name="dzPassword" id="dzPassword1" required type={hide ? "text" : "password"} className="dzPassword mt-2.5 flex relative border border-[#dddddd] w-full rounded-md py-2.5 px-5 focus:ring-primary" placeholder="Create a Password" />
                  <div className={`show-pass ${hide ? 'active' : ''}`}
            ...
            <button name="submit" value="submit" type="reset" className="btn btn-primary w-full block">
              <span>Sign Up</span>
            </button>
            <p className="text-center mt-[30px] text-base">
              Already have an account?{" "}
              <Link to={"#"} className="text-primary font-medium"
                onClick={() => { setRegistered(false); setShowSignInForm(true);}}
              >
                Login
              </Link>
            </p>
